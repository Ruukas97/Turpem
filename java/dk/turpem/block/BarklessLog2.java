...
public class BarklessLog2 extends BlockLog
{
    public static final String[] types = new String[] {"oak", "spruce"};
    
    public BarklessLog2(String name){
    	setBlockName(name + "");
    	setBlockTextureName(name);
    	GameRegistry.registerBlock(this, BarklessLogItem2.class, Turpem.MODID + name + "2");
