...
public class TurpemChest extends BlockContainer
{
    private final Random random = new Random();
    public final int type;

    public TurpemChest(String name, int type, Material material)
    {
        super(material);
        this.type = type;
    ...
    {
        return TileEntityTurpemChestRenderer.renderId;
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            ((TileEntityTurpemChest)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145976_a(p_149689_6_.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityTurpemChest TileEntityTurpemChest = (TileEntityTurpemChest)p_149695_1_.getTileEntity(p_149695_2_, p_149695_3_, p_149695_4_);

        if (TileEntityTurpemChest != null)
        {
            TileEntityTurpemChest.updateContainingBlockInfo();
        }
    }

    public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        TileEntityTurpemChest TileEntityTurpemChest = (TileEntityTurpemChest)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);

        if (TileEntityTurpemChest != null)
        {
            for (int i1 = 0; i1 < TileEntityTurpemChest.getSizeInventory(); ++i1)
            {
                ItemStack itemstack = TileEntityTurpemChest.getStackInSlot(i1);
    ...
    {
        Object object = (TileEntityTurpemChest)world.getTileEntity(x, y, z);
        ...
        else
        {
            ...
            {
                object = new InventoryLargeChest("Large " +  typeName(type) + " Chest", (TileEntityTurpemChest)world.getTileEntity(x - 1, y, z), (IInventory)object);
            }

            if (world.getBlock(x + 1, y, z) == this)
            {
                object = new InventoryLargeChest("Large " +  typeName(type) + " Chest", (IInventory)object, (TileEntityTurpemChest)world.getTileEntity(x + 1, y, z));
            }

            if (world.getBlock(x, y, z - 1) == this)
            {
                object = new InventoryLargeChest("Large " +  typeName(type) + " Chest", (TileEntityTurpemChest)world.getTileEntity(x, y, z - 1), (IInventory)object);
            }

            if (world.getBlock(x, y, z + 1) == this)
            {
                object = new InventoryLargeChest("Large " +  typeName(type) + " Chest", (IInventory)object, (TileEntityTurpemChest)world.getTileEntity(x, y, z + 1));
            }
    ...
    {
        TileEntityTurpemChest TileEntityTurpemChest = new TileEntityTurpemChest();
        return TileEntityTurpemChest;
    }
