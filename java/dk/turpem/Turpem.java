...
public class Turpem
{
     ...
     */
    public static final List<String> donators = Arrays.asList(new String[] {});
     ...
     */
    public void setModMeta()
    {
        final List<String> coders = Arrays.asList(new String[] {"GamingTutsDK"});
        meta.modId = MODID;
        meta.name = NAME;
