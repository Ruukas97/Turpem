...
public class TileEntityTurpemChest extends TileEntity implements IInventory
{
    private ItemStack[] chestContents = new ItemStack[18];
    /** Determines if the check for adjacent chests has taken place. */
    public boolean adjacentChestChecked;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTurpemChest adjacentChestZNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTurpemChest adjacentChestXPos;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTurpemChest adjacentChestXNeg;
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityTurpemChest adjacentChestZPos;
    ...
    public TileEntityTurpemChest()
    {
        this.cachedChestType = -1;
    }

    @SideOnly(Side.CLIENT)
    public TileEntityTurpemChest(int par1)
    {
    ...
    {
        return this.hasCustomInventoryName() ? this.customName : TurpemChest.typeName(cachedChestType) + " Chest";
    }
    ...
    private void func_145978_a(TileEntityTurpemChest p_145978_1_, int p_145978_2_)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityTurpemChest)this.worldObj.getTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityTurpemChest)this.worldObj.getTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityTurpemChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_145977_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPos = (TileEntityTurpemChest)this.worldObj.getTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_145977_a(int p_145977_1_, int p_145977_2_, int p_145977_3_)
    {
        ...
        return block instanceof TurpemChest && ((TurpemChest)block).type == this.func_145980_j();
    }
    ...
    {
        if (this.getBlockType() instanceof TurpemChest)
        {
            --this.numPlayersUsing;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType(), 1, this.numPlayersUsing);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType());
    ...
    public int func_145980_j()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof TurpemChest))
            {
                return 0;
            }

            this.cachedChestType = ((TurpemChest)this.getBlockType()).type;
        }
    ...
    /**
     * Gets or sets the block type at the location of this entity (client-only).
     */
    public Block setOrGetBlockType(Block block)
    {
