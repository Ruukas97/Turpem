...
public class GuiTurpemMainMenu extends GuiMainMenu implements GuiYesNoCallback
{
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        GuiButton turpemDonators = new GuiButton(16, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 3, "Donators");
        fmlModButton.xPosition = this.width / 2 + 2;
        realmsButton.width = 98;
        fmlModButton.width = 98;
        this.buttonList.add(realmsButton);
        this.buttonList.add(fmlModButton);
        this.buttonList.add(turpemDonators);
    }
    ...
    protected void actionPerformed(GuiButton p_146284_1_)
    {
		...
		case 12:
			...
			break;
		case 16:
			this.mc.displayGuiScreen(new GuiNameChange(FMLClientHandler.instance().getClient().thePlayer));
		}
    }
