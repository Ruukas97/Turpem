...
public class RenderPlayerTurpem extends RenderPlayer
{
    ...
    public RenderPlayerTurpem()
    {
        super();
        this.modelBipedMain = (ModelBiped)this.mainModel;
        this.modelArmorChestplate = new ModelBiped(1.0F);
        this.modelArmor = new ModelBiped(1.5F);
    }

    /**
     * Queries whether should render the specified pass or not.
     */
    protected int shouldRenderPass(AbstractClientPlayer clientPlayer, int p_77032_2_, float p_77032_3_)
    {
        ItemStack itemstack = clientPlayer.inventory.armorItemInSlot(3 - p_77032_2_);
        ...
        if (itemstack != null)
        {
            ...
            if (item instanceof ItemArmor)
            {
                ...
                this.bindTexture(RenderBiped.getArmorResource(clientPlayer, itemstack, p_77032_2_, null));
                ...
                modelbiped = net.minecraftforge.client.ForgeHooksClient.getArmorModel(clientPlayer, itemstack, p_77032_2_, modelbiped);
